...
- **动作市场**：卡片网格，支持搜索、运行环境筛选、仅看可更新与分页（每页 20 / 50 / 100）；点击卡片在弹窗中查看说明、源代码与历史版本，再导入为草稿。右上角「市场设置」配置一个市场地址，支持 HTTP 和 HTTPS，包括局域网地址。
- **关于**：版本、下载、GitHub、指南与支持的 App。

动作图标统一为单色线条（跟随文字颜色），与网页市场一致。图标库提供文件、图片、办公、开发、网络和工具六类共 64 个内置图标，支持搜索；市场导入的自定义图标继续显示，也可从图标库替换。动作详情及升级日志可直接阅读 Markdown 标题、列表、代码块和参数表格。
